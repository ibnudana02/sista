				...
				<form action="<?= site_url('agenda/proses') ?>" method="post" class="form-horizontal form-label-left" autocomplete="off">
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-5 col-xs-12">
							<input id="tgl_start" type="text" placeholder="" class="form-control datepicker" name="tgl_start" required>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-xs-12">Tanggal Selesai Acara *</label>
						<div class="col-md-3 col-sm-5 col-xs-12">
							<input id="tgl_end" type="text" placeholder="" class="form-control datepicker" name="tgl_end" required>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-md-4 col-sm-4 col-xs-12">Jam Mulai Acara *</label>
						<div class="col-md-3 col-sm-5 col-xs-12">
							<input id="jam_start" type="text" name="jam_start" class="form-control col-md-7 col-xs-12 timepicker" required>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-md-3 col-sm-5 col-xs-12">
							<input id="jam_end" type="text" name="jam_end" class="form-control col-md-7 col-xs-12 timepicker" required>
