...
<page>
    ...
    <div class="header">
        <h3 class="h" style="margin-top: 20px;">PEMERINTAH KABUPATEN PELALAWAN</h3>
        <h3 class="h">DINAS KESEHATAN KABUPATEN PELALAWAN</h3>
        <div align="center" style="font-weight:bold;">Komplek Bhakti Praja Pelalawan Telp. (0761) 95850</div>
        <div align="center" style="font-weight:bold;">Email : dinkes@pelalawankab.go.id</div>
    ...
    <div class="footer">
        <div style="border:0px solid; margin: 0 60px;">
            <div style="margin-left:400px;">Ditetapkan di Pangkalan Kerinci</div>
