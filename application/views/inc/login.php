...
<head>
	...
	<meta name="description" content="Aplikasi Surat Menyurat dan SPPD Kominfo Kabupaten Kudus by YukCoding Media">
	<meta name="author" content="YukCoding Media">
	<title>Login - Sistasur</title>
	...
	<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
		<div class="page-content">
			<div class="page-brand-info">
				<div class="brand">
					<h2 class="brand-text font-size-40" style="margin:0;">Sistasur
				</h2>
				</div>
				<p class="font-size-20">Aplikasi yang digunakan untuk mempermudah pengarsipan dan pengolahan persuratan pada Kantor Dinas Kesehatan Kabupaten Pelalawan</p>
			</div>
