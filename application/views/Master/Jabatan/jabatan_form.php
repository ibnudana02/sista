			...
			<div class="x_content">
				<form action="<?=site_url('jabatan/proses')?>" method="post" class="form-horizontal form-label-left" autocomplete="off">
					...
					<div class="form-group">
						...
						<div class="col-sm-3 col-xs-12">
							<select name="level" class="form-control" required>
	                            ...
	                            <option value="2" <?=$row->level_jabatan == '2' ? 'selected' : null?>>Level 1 (Kepala Dinas)</option>
	                            <option value="3" <?=$row->level_jabatan == '3' ? 'selected' : null?>>Level 2 (Kabid, Sekretaris)</option>
	                            <option value="4" <?=$row->level_jabatan == '4' ? 'selected' : null?>>Level 3 (Kasi, Kasub)</option>
	                            <option value="5" <?=$row->level_jabatan == '5' ? 'selected' : null?>>Level 4 (Staff)</option>
	                          </select>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-5 col-xs-12">
							<textarea name="uraian" class="form-control col-md-7 col-xs-12" <?php if($row->uraian == '(tidak ada jabatan)') { echo "readonly"; }?>><?=$row->uraian?></textarea>
						</div>
					</div>
