    ...
    L.extend(L.datetimepicker, t), r(), window.getComputedStyle || (window.getComputedStyle = function (a) {
        ...
        return this.each(function () {
            ...
            "hide" !== y ? (L(this).hasClass("xdsoft_scroller_box") || (n = l.children().eq(0), f = Math.abs(parseInt(n.css("marginTop"), 10)), i = l[0].clientHeight, s = n[0].offsetHeight, d = L('<div class="xdsoft_scrollbar"></div>'), u = L('<div class="xdsoft_scroller"></div>'), d.append(u), l.addClass("xdsoft_scroller_box").append(d), p = function (e) {
                ...
                var t, a, o = (t = e.originalEvent, a = 0, "detail" in t && (a = t.detail), "wheelDelta" in t && (a = -t.wheelDelta / 120), "wheelDeltaY" in t && (a = -t.wheelDeltaY / 120), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (a = 0), a *= 10, "deltaY" in t && (a = t.deltaY), a && t.deltaMode && (1 === t.deltaMode ? a *= 40 : a *= 800), a),
                    r = Math.max(0, f - o);
        ...
        return o = function (w) {
            ...
            I.id && _.attr("id", I.id), I.style && _.attr("style", I.style), I.weeks && _.addClass("xdsoft_showweeks"), I.rtl && _.addClass("xdsoft_rtl"), _.addClass("xdsoft_" + I.theme), _.addClass(I.className), F.find(".xdsoft_month span").after(A), F.find(".xdsoft_year span").after(Y), F.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (e) {
                var t, a, o = L(this).find(".xdsoft_select").eq(0),
                    r = 0,
                    n = 0,
                    i = o.is(":visible");
            ...
            function c(m) {
                ...
                m.mask && w.off("keydown.xdsoft"), !0 === m.mask && (E.formatMask ? m.mask = E.formatMask(m.format) : m.mask = m.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === L.type(m.mask) && (h(m.mask, w.val()) || (w.val(m.mask.replace(/[0-9]/g, "_")), g(w[0], 0)), w.on("paste.xdsoft", function (e) {
                    ...
                    if (48 <= o && o <= 57 || 96 <= o && o <= 105 || 8 === o || 46 === o) {
                        ...
                        for (r += 8 === o ? 0 : 1;
                            /[^0-9_]/.test(m.mask.substr(r, 1)) && r < m.mask.length && 0 < r;) r += 8 === o ? 0 : 1;
            ...
            F.find(".xdsoft_select").xdsoftScroller(I).on("touchstart mousedown.xdsoft", function (e) {
                ...
                I = L.extend(!0, {}, I, e), e.allowTimes && L.isArray(e.allowTimes) && e.allowTimes.length && (I.allowTimes = L.extend(!0, [], e.allowTimes)), e.weekends && L.isArray(e.weekends) && e.weekends.length && (I.weekends = L.extend(!0, [], e.weekends)), e.allowDates && L.isArray(e.allowDates) && e.allowDates.length && (I.allowDates = L.extend(!0, [], e.allowDates)), e.allowDateRe && "[object String]" === Object.prototype.toString.call(e.allowDateRe) && (I.allowDateRe = new RegExp(e.allowDateRe)), e.highlightedDates && L.isArray(e.highlightedDates) && e.highlightedDates.length && (L.each(e.highlightedDates, function (e, t) {
                    ...
                    var a, o, r, n, i, s, d;
                    if (L.isArray(t)) a = t[0], o = t[1], r = t[2], d = t[3];
                    else {
                ...
                clearTimeout(t), t = setTimeout(function () {
                    ...
                    if (s = function (e, t) {
                        ...
                        for (c = 0; c < I.allowTimes.length; c += 1) s(W.strtotime(I.allowTimes[c]).getHours(), O = W.strtotime(I.allowTimes[c]).getMinutes());
                    else
