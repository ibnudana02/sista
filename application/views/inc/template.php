...
<head>
	...
	<!-- <link href="<?= base_url() ?>assets/vendors/timepicker/lib/tpicker.css" rel="stylesheet"> -->
...
<body class="nav-md">
		...
		<div class="main_container">
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="" class="site_title"><span>SISTASUR</span></a>
					</div>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li>
										<a href="<?= site_url('profile') ?>">Profile <i class="fa fa-user pull-right"></i></a>
									</li>
									<li>
										<a href="<?= site_url('auth/logout') ?>"><i class="fa fa-sign-out pull-right"></i> Log Out</a>
									</li>
								</ul>
							</li>
			...
			<footer>
				<div class="pull-right">
					Copyright &copy; TugasAkhirABD <?= date('Y'); ?>
				</div>
				<div class="clearfix"></div>
			</footer>
		</div>
	...
	<!-- <script src="<?= base_url() ?>assets/build/js/jquery.datetimepicker.full.min.js"></script> -->
	<!-- <script src="<?= base_url() ?>assets/build/js/jquery.datetimepicker.full.js"></script> -->
	<script src="<?= base_url() ?>assets/build/js/custom.js"></script>
	<script src="<?= base_url() ?>assets/build/js/popper.min.js"></script>
	<script src="<?= base_url() ?>assets/build/js/datepickercustom.js"></script>
	<!-- <script src="<?= base_url() ?>assets/build/js/timepickercustom.js"></script> -->
</body>
